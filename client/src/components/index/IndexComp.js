...
const IndexComp = () => {
    ...
    const filtered2 = filtered.sort((a, b) => {
    ...
    const filtered3 = filtered2.filter(x => checkboxLTU ? x.area < 65300 : x)
    const filtered4 = filtered3.filter(x => checkboxOceana ? x.region === "Oceania" : x)
            ...
            <div className="form">
                ...
                <div className="indexBody">
                    {spinner ?
                        ...
                        <div>
                            {status === null ?
                                pagination.map((x, i) => <SingleRow key={i} country={x}/>)
                                :
